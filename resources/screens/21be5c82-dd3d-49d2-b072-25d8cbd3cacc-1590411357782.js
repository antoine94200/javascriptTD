jQuery("#simulation")
  .on("click", ".s-21be5c82-dd3d-49d2-b072-25d8cbd3cacc .click", function(event, data) {
    ...
    if(jFirer.is("#s-icon_menu")) {
              ...
              "actions": [
                {
                  ...
                  "parameter": [ {
                    "#s-21be5c82-dd3d-49d2-b072-25d8cbd3cacc #s-icon_menu > svg": {
                      "attributes": {
                        "overlay": "#EF7F72"
                      }
                    }
                ...
                },
                {
                  "action": "jimChangeStyle",
                  "parameter": [ {
                    "#s-21be5c82-dd3d-49d2-b072-25d8cbd3cacc #s-icon_livre > svg": {
                      "attributes": {
                        "overlay": "#8A8A8F"
                      }
                    }
                  },{
                    "#s-21be5c82-dd3d-49d2-b072-25d8cbd3cacc #s-icon_maison > svg": {
                      "attributes": {
                        "overlay": "#8A8A8F"
                      }
                    }
                  },{
                    "#s-21be5c82-dd3d-49d2-b072-25d8cbd3cacc #s-icon_profil > svg": {
                      "attributes": {
                        "overlay": "#8A8A8F"
                      }
                    }
              ...
              "actions": [
                {
                  "action": "jimShow",
                  "parameter": {
                    "target": [ "#s-Text_9","#s-Rectangle_13" ]
                  },
                  "exectype": "serial",
                  "delay": 0
                }
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-checkbox_4")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("pageload", ".s-21be5c82-dd3d-49d2-b072-25d8cbd3cacc .pageload", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
